...
func (d *storeWorker) maybeCreatePeer(regionID uint64, msg *rspb.RaftMessage) (bool, error) {
	log.Infof("maybeCreatePeer storeID=%d regionID=%d fromPeer=%v toPeer=%v epoch=%v tombstone=%v",
		d.ctx.store.Id, msg.RegionId, msg.FromPeer, msg.ToPeer, msg.RegionEpoch, msg.IsTombstone)
